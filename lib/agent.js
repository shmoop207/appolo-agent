...
class Agent extends appolo_event_dispatcher_1.EventDispatcher {
    constructor(options) {
        ...
        this.handle = (request, response) => {
            try {
                this._initRequest(request, response);
                middleware_1.handleMiddleware(request, response, 0, this._middlewares);
            }
            catch (e) {
                errorHandler_1.ErrorHandler.handleError(e, response);
            }
        };
